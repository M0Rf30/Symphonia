...
//! direction comes from `sbr_dtdf()` ([`super::grid::SbrDtdf`]):
//!
...
//! ([`super::freq_bands::HiLoTables`]). The noise band count is
...
use super::grid::{SbrDtdf, SbrGrid};
use super::huffman::{env_tables, noise_tables, sbr_huff_dec, SbrHuffContext};
...
fn num_env_bands(bands: &super::freq_bands::HiLoTables, high_res: bool) -> usize {
    if high_res {
        bands.n_high()
    } else {
        bands.n_low()
...
impl SbrEnvelopeData {
    ...
    pub fn parse(
        ...
        grid: &SbrGrid,
        dtdf: &SbrDtdf,
        bands: &super::freq_bands::HiLoTables,
        coupling: bool,
        ch: bool,
        amp_res: bool,
    ) -> Result<Self> {
...
impl SbrNoiseData {
    ...
    /// ([`super::freq_bands::HiLoTables::n_q`]). The other
...
mod tests {
    use super::*;
    use super::super::freq_bands::{k0, k2, master_table, HiLoTables};
    use super::super::grid::FrameClass;
