...
mod tests {
    ...
    fn patch_invariants_on_derived_master() {
        let fs_sbr = 44_100;
        let k0 = super::super::freq_bands::k0(fs_sbr, 5).unwrap();
        let k2 = super::super::freq_bands::k2(fs_sbr, 5, k0).unwrap();
        let fm = super::super::freq_bands::master_table(k0, k2, 2, true).unwrap();
